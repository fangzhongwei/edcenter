...
object EdServiceEndpoint { self =>
  ...
  trait BaseServiceIface extends ToThriftService {
    def encrypt : com.twitter.finagle.Service[self.Encrypt.Args, self.Encrypt.SuccessType]
    def decrypt : com.twitter.finagle.Service[self.Decrypt.Args, self.Decrypt.SuccessType]

    def toThriftService: ThriftService = new MethodIface(this)
  }

  case class ServiceIface(
      encrypt : com.twitter.finagle.Service[self.Encrypt.Args, self.Encrypt.SuccessType],
      decrypt : com.twitter.finagle.Service[self.Decrypt.Args, self.Decrypt.SuccessType]
    ...
    def filtered(filter: com.twitter.finagle.Filter.TypeAgnostic): ServiceIface =
      copy(
        encrypt = filter.toFilter.andThen(encrypt),
        decrypt = filter.toFilter.andThen(decrypt)
      )
  }
  ...
  class MethodIface(serviceIface: BaseServiceIface)
    ...
    def encrypt(traceId: String, raw: String): Future[com.jxjxgo.edcenter.rpc.domain.EncryptResponse] =
      serviceIface.encrypt(self.Encrypt.Args(traceId, raw))
    def decrypt(traceId: String, ticket: String): Future[com.jxjxgo.edcenter.rpc.domain.DecryptResponse] =
      serviceIface.decrypt(self.Decrypt.Args(traceId, ticket))
  }
  ...
  object Encrypt extends com.twitter.scrooge.ThriftMethod {
    ...
    class Result(
      ...
      with _root_.scala.Product1[Option[com.jxjxgo.edcenter.rpc.domain.EncryptResponse]]
    ...
    val name: String = "encrypt"
    val serviceName: String = "EdServiceEndpoint"
    val argsCodec = Args
  ...
  object Decrypt extends com.twitter.scrooge.ThriftMethod {
    ...
    class Result(
      ...
      with _root_.scala.Product1[Option[com.jxjxgo.edcenter.rpc.domain.DecryptResponse]]
      with HasThriftStructCodec3[Result]
      with java.io.Serializable
    {
      import Result._
