...
object EncryptResponse extends ThriftStructCodec3[EncryptResponse] {
  ...
  def unapply(_item: EncryptResponse): _root_.scala.Option[_root_.scala.Tuple2[String, String]] = _root_.scala.Some(_item.toTuple)
...
trait EncryptResponse
  ...
  with HasThriftStructCodec3[EncryptResponse]
  with java.io.Serializable
{
  ...
  private def _equals(x: EncryptResponse, y: EncryptResponse): Boolean =
      x.productArity == y.productArity &&
      x.productIterator.sameElements(y.productIterator)

  override def equals(other: Any): Boolean =
    canEqual(other) &&
      _equals(this, other.asInstanceOf[EncryptResponse]) &&
  ...
  def _codec: ThriftStructCodec3[EncryptResponse] = EncryptResponse
}